...
useEffect(() => {
    ...
    else if (location.pathname === "/forgot-password") setMode("forgot");
}, [location.pathname]);


useEffect(() => {
    if (mode === "login") navigate("/login", { replace: true });
    else if (mode === "register") navigate("/register", { replace: true });
    else if (mode === "forgot") navigate("/forgot-password", { replace: true });
}, [mode, navigate]);
